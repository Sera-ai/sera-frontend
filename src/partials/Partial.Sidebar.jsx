        ...
        <div className="space-y-8">
          ...
          <div>
            <ul className="sidebarList">
              {/* Inbox */}
              <li className={`sidebarItem rounded-sm mb-0.5 last:mb-0 flex items-center justify-center ${(pathname === '/' || pathname.includes('dashboard')) && 'secondaryDarkPadded'}`}>
                <NavLink
                  end
                  to="/"
                ...
                >
                  <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 20 20" fill="none">
                    <path d="M3 10H1L10 1L19 10H17M3 10V17C3 17.5304 3.21071 18.0391 3.58579 18.4142C3.96086 18.7893 4.46957 19 5 19H15C15.5304 19 16.0391 18.7893 16.4142 18.4142C16.7893 18.0391 17 17.5304 17 17V10" stroke={(pathname === '/' || pathname.includes('dashboard')) ? '#2B84EC' : '#FFFFFF50'} strokeLinecap="round" strokeLinejoin="round" />
                    <path d="M7 19V13C7 12.4696 7.21071 11.9609 7.58579 11.5858C7.96086 11.2107 8.46957 11 9 11H11C11.5304 11 12.0391 11.2107 12.4142 11.5858C12.7893 11.9609 13 12.4696 13 13V19" stroke={(pathname === '/' || pathname.includes('dashboard')) ? '#2B84EC' : '#FFFFFF50'} strokeLinecap="round" strokeLinejoin="round" />
                  </svg>
                </NavLink>
              </li>
              <li className={`sidebarItem rounded-sm mb-0.5 last:mb-0 flex items-center justify-center ${(pathname.includes('issues')) && 'secondaryDarkPadded'}`}>
                <NavLink
                  end
                  to="/issues"
                  className={`block text-slate-200 truncate transition duration-150 ${(pathname.includes('issues')) ? 'hover:text-slate-200' : 'hover:text-white'
                    }`}
                >
                  <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 20 20" fill="none">
                    <path d="M9.99983 1C12.3357 3.06658 15.3843 4.14257 18.4998 4C18.9534 5.54302 19.0922 7.16147 18.908 8.75918C18.7237 10.3569 18.2202 11.9013 17.4272 13.3005C16.6343 14.6998 15.5682 15.9254 14.2923 16.9045C13.0164 17.8836 11.5566 18.5962 9.99983 19C8.44305 18.5962 6.98331 17.8836 5.70738 16.9045C4.43144 15.9254 3.36534 14.6998 2.57243 13.3005C1.77952 11.9013 1.27597 10.3569 1.09171 8.75918C0.907451 7.16147 1.04624 5.54302 1.49983 4C4.61536 4.14257 7.664 3.06658 9.99983 1Z" stroke={(pathname.includes('anomaly')) ? '#2B84EC' : '#FFFFFF50'} strokeLinecap="round" strokeLinejoin="round" />
                    <path d="M2 12L10 9L18 12" stroke={(pathname.includes('issues')) ? '#2B84EC' : '#FFFFFF50'} strokeLinecap="round" strokeLinejoin="round" />
                  </svg>
                </NavLink>
              </li>
              <li className={`sidebarItem sidebarEndItem rounded-sm mb-0.5 last:mb-0 flex items-center justify-center ${(pathname.includes('catalog')) && 'secondaryDarkPadded'}`}>
                <NavLink
                  ...
                  to="/catalog"
                  className={`block text-slate-200 truncate transition duration-150 ${(pathname.includes('catalog')) ? 'hover:text-slate-200' : 'hover:text-white'
                    }`}
                >
                  <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 18 18" fill="none">
                    <path d="M5 10L1 8V3L5 1L9 3M5 10L9 8M5 10V15L9 17L13 15V10M9 8V3M9 8L13 10M9 3L13 1L17 3V8L13 10" stroke={(pathname.includes('catalog')) ? '#2B84EC' : '#FFFFFF50'} strokeLinecap="round" strokeLinejoin="round" />
                  </svg>
                </NavLink>
              </li>
              <li className={`sidebarItem rounded-sm mb-0.5 last:mb-0 flex items-center justify-center`}>
                <NavLink
                  end
                  to="/ecosystem"
                  className={`block text-slate-200 truncate transition duration-150 ${(pathname.includes('ecosystem')) ? 'hover:text-slate-200' : 'hover:text-white'
                    }`}
                >
                  <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 20 20" fill="none">
              ...
              <li className={`sidebarItem sidebarEndItem rounded-sm mb-0.5 last:mb-0 flex items-center justify-center ${(pathname.includes('honeycomb')) && 'secondaryDarkPadded'}`}>
                <NavLink
                  end
                  to="/"
                ...
                >
                  <svg xmlns="http://www.w3.org/2000/svg" width="28" height="22" viewBox="0 0 20 22" fill="none">
              ...
              <li className={`sidebarItem rounded-sm mb-0.5 last:mb-0 flex items-center justify-center`}>
                ...
                >
                  <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none">
                    <path d="M8 12C8 13.0609 8.42143 14.0783 9.17157 14.8284C9.92172 15.5786 10.9391 16 12 16C13.0609 16 14.0783 15.5786 14.8284 14.8284C15.5786 14.0783 16 13.0609 16 12C16 10.9391 15.5786 9.92172 14.8284 9.17157C14.0783 8.42143 13.0609 8 12 8C10.9391 8 9.92172 8.42143 9.17157 9.17157C8.42143 9.92172 8 10.9391 8 12Z" stroke="white" strokeLinecap="round" strokeLinejoin="round" />
                    <path d="M15 15L18.35 18.35M9 15L5.65 18.35M5.65 5.65L9 9M18.35 5.65L15 9M3 12C3 13.1819 3.23279 14.3522 3.68508 15.4442C4.13738 16.5361 4.80031 17.5282 5.63604 18.364C6.47177 19.1997 7.46392 19.8622 8.55585 20.3149C9.64778 20.7672 10.8181 21 12 21C13.1819 21 14.3522 20.7672 15.4442 20.3149C16.5361 19.8622 17.5282 19.1997 18.364 18.364C19.1997 17.5282 19.8622 16.5361 20.3149 15.4442C20.7672 14.3522 21 13.1819 21 12C21 10.8181 20.7672 9.64778 20.3149 8.55585C19.8622 7.46392 19.1997 6.47177 18.364 5.63604C17.5282 4.80031 16.5361 4.13738 15.4442 3.68508C14.3522 3.23279 13.1819 3 12 3C10.8181 3 9.64778 3.23279 8.55585 3.68508C7.46392 4.13738 6.47177 4.80031 5.63604 5.63604C4.80031 6.47177 4.13738 7.46392 3.68508 8.55585C3.23279 9.64778 3 10.8181 3 12Z" stroke="white" strokeLinecap="round" strokeLinejoin="round" />
                  </svg>
                </NavLink>
              </li>
              {/* Settings */}
