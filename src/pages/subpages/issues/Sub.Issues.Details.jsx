            ...
            <div className="flex justify-between items-center">
                <div className="">
                    ...
                    <div className="secondaryDark rounded-md mt-2 py-1 px-2 inline-block">
                        <h2 className="font-light text-slate-800 dark:text-slate-100 text-xs">API rate limit exceeded without throttling</h2>
                    </div>
                </div>
                <div className="space-x-2.5 flex justify-center">
                    <button onClick={() => { }} className={true ? "btn bg-indigo-500 hover:bg-indigo-600 text-white" : "btn hover:bg-indigo-600 rounded-md border border-slate-200 dark:border-slate-700 text-white"}>
