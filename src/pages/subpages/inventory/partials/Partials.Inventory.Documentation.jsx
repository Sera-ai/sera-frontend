...
const Documentation = ({
  ...
  return (
    <div className="overflow-x-auto flex h-full w-full">
      {/* Data Div */}
      <div
        className={`flex w-full h-full flex-row ${!editDocs && "hideToolbar"}`}
      >
        {manageOAS ? (
          <OasEditor
            ref={oasEditorRef}
          ...
          <div className="flex flex-col w-full h-full overflow-y-scroll no-scrollbar p-2 gap-14">
            {!endpoint && (
              <div className="gap-2 flex flex-col">
                <span className={"docHeading"}>{oas.info?.title}</span>
