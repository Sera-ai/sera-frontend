...
function PluginComponent({ endpoint, availablePlugins }) {
  const enabled = (
    <svg
    ...
    <div className="py-4 rounded-md">
      {availablePlugins[endpoint].map((option, index) => (
        <div
          ...
          className={`flex items-center py-2 px-3 ${
            index === 0
              ...
              : index === availablePlugins[endpoint].length - 1
        ...
        >
          <div
            style={{
              backgroundColor: option.enabled ? "#2B84EC" : "#23232E",
              height: 30,
              width: 30,
            }}
