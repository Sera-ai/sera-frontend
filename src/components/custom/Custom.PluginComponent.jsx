    ...
    return (
        <div className="py-4 rounded-md">
            {availablePlugins[endpoint].map((option, index) => (
                ...
                >
                    <div style={{ backgroundColor: option.enabled ? "#2B84EC" : "#23232E", height: 30, width: 30 }} className={` flex justify-center items-center rounded-md mr-4`}>{option.enabled ? enabled : disabled}</div>
