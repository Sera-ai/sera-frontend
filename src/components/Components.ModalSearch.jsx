...
function ModalSearch({
  ...
  return (
    <>
      {/* Modal backdrop */}
      <Transition
        className="fixed inset-0 secondaryDark bg-opacity-30 z-50 transition-opacity"
        show={modalOpen}
      ...
      >
        <div
          ref={modalContent}
          className="bg-white mainDark border border-transparent dark:border-slate-700 overflow-auto max-w-2xl w-full max-h-full rounded shadow-lg"
        >
          {/* Search form */}
          <form className="border-b border-slate-200 dark:border-slate-700">
            <div className="relative">
              ...
              <input
                id={searchId}
                className="w-full dark:text-slate-300 bg-white mainDark border-0 focus:ring-transparent placeholder-slate-400 dark:placeholder-slate-500 appearance-none py-3 pl-10 pr-4"
                type="search"
