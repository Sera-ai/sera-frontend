...
function DropdownHelp({
  ...
  return (
    <div className="relative inline-flex">
      ...
      <Transition
        className={`origin-top-right z-10 absolute top-full min-w-44  mainDark border border-slate-200 dark:border-slate-700 py-1.5 rounded shadow-lg overflow-hidden mt-1 ${align === 'right' ? 'right-0' : 'left-0'}`}
        show={dropdownOpen}
